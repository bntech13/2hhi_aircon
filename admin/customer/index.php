...
?>
    ...
    <div class="card">
        <div class="card-header" style="background-color: rgb(83, 160, 248); border-bottom: 2px solid rgb(83, 160, 248); position: relative; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.2); display: flex; justify-content: center; align-items: center;">
            <div style="display: inline-block; border: 2px solid white; border-radius: 10px; padding: 8px 20px; margin-top: 0px; position: relative; z-index: 2; background-color: rgba(255, 255, 255, 0.1);">
                <h6 style="color: white; margin: 0; text-shadow: 0 1px 2px rgb(83, 160, 248); text-align: center;">
                 <i class="fas fa-users fa-lg" style="color: white;"></i> <b>CUSTOMER LIST</b>
                </h6>
            </div>
        </div>
    <div class="card-body">
...
<div class="modal fade" id="taskModal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #004492ff; color: white;">
            ...
            <div class="modal-body">
                <div class="card" style="border: 2px solid #004492ff; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                    <div class="card-header" style="background-color: #004492ff; color: white; border-bottom: 2px solid #004492ff;">
